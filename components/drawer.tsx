    ...
    return (
        <DrawerPortal data-slot="drawer-portal">
            ...
            <DrawerPrimitive.Content
                ...
                className={cn(
                    "group/drawer-content bg-body fixed z-50 flex h-auto flex-col",
                ...
                {...props}
            >
                <div className="bg-on-body/10 mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
                {children}
            </DrawerPrimitive.Content>
        </DrawerPortal>
    );
...
function DrawerTitle({
    ...
    return (
        <DrawerPrimitive.Title
            ...
            className={cn("text-on-body font-semibold", className)}
            {...props}
        />
    );
}
